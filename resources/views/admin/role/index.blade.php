...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{ route('admin.role.edit', ['id' => $role->idrole]) }}" class="btn-edit">✏ Edit</a>
                <form action="{{ route('admin.role.destroy') }}" method="POST" style="display:inline;">
                    @csrf
        ...
        @empty
        <tr><td colspan="3">Tidak ada data role.</td></tr>
        @endforelse
    </tbody>
</table>
