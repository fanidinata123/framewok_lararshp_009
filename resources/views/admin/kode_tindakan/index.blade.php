...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{ route('admin.kode-tindakan.edit', $item->idkode_tindakan_terapi) }}" class="btn-edit">✏ Edit</a>
                <form action="{{ route('admin.kode-tindakan.destroy', $item->idkode_tindakan_terapi) }}" method="POST" style="display:inline;">
                    @csrf @method('DELETE')
