...
<head>
    ...
    <style>
        ...
        .btn-edit,.btn-delete{padding:6px 12px;border:none;border-radius:4px;color:white;font-size:14px;cursor:pointer;text-decoration:none;}
...
<div class="nav-container">
    ...
    <a href="{{ route('admin.pemilik.create') }}" class="btn btn-add">➕ Tambah Pemilik</a>
</div>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ $p->alamat }}</td>
            <td>
                <a href="{{ route('admin.pemilik.edit', ['id' => $p->idpemilik]) }}" class="btn-edit">✏ Edit</a>
                <form action="{{ route('admin.pemilik.destroy') }}" method="POST" style="display:inline;">
                    @csrf
        ...
        @empty
        <tr><td colspan="5">Tidak ada data pemilik.</td></tr>
        @endforelse
    </tbody>
</table>
