...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('resepsionis.pet.update') }}" method="POST">
            @csrf
            <input type="hidden" name="id" value="{{ $pet->idpet }}">
            
            <div class="mb-3">
                <label for="nama" class="form-label">Nama Pet <span class="text-danger">*</span></label>
                <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" value="{{ old('nama', $pet->nama) }}" required>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('warna_tanda') is-invalid @enderror" id="warna_tanda" name="warna_tanda" value="{{ old('warna_tanda', $pet->warna_tanda) }}">
