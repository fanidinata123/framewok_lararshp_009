...
<head>
    ...
    <title>@yield('title') - Perawat Panel</title>
        ...
        <div class="sidebar-wrapper">
            <nav class="mt-2">
                <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('perawat.dashboard') }}" class="nav-link {{ Request::is('perawat/dashboard') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('perawat.pasien.index') }}" class="nav-link {{ Request::is('perawat/pasien*') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('perawat.rekam-medis.index') }}" class="nav-link {{ Request::is('perawat/rekam-medis*') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('perawat.profil') }}" class="nav-link {{ Request::is('perawat/profil') ? 'active' : '' }}">
