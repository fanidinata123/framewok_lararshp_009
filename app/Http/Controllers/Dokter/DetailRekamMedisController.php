...
class DetailRekamMedisController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('dokter.detail_rekam_medis.index', compact('rekam','details'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('dokter.detail_rekam_medis.create', compact('rekam','tindakan'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dokter.detail-rekam-medis.index', ['idrekam_medis' => $data['idrekam_medis']])->with('success','Detail rekam medis ditambahkan.');
    }
    ...
    public function edit(Request $request)
    {
        ...
        $tindakan = KodeTindakanTerapi::all();
        return view('dokter.detail_rekam_medis.edit', compact('detail','tindakan'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('dokter.detail-rekam-medis.index', ['idrekam_medis' => $row->idrekam_medis])->with('success','Detail diupdate.');
    }
    ...
    public function destroy(Request $request)
    {
        ...
        $row->delete();
        return redirect()->route('dokter.detail-rekam-medis.index', ['idrekam_medis' => $idrekam])->with('success','Detail dihapus.');
    }
