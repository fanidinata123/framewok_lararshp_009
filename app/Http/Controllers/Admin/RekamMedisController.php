...
class RekamMedisController extends Controller
{
    public function index()
    {
        ...
        return view('admin.rekam_medis.index', compact('rekams'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.rekam_medis.create', compact('pets','dokters','temus'));
    }
    ...
    public function edit(Request $request)
    {
        ...
        return view('admin.rekam_medis.edit', compact('rekam','pets','dokters'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('admin.rekam-medis.index')->with('success','Rekam medis berhasil diupdate.');
    }
