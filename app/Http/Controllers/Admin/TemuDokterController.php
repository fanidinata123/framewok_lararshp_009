...
class TemuDokterController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.temu_dokter.create', compact('pets','dokters'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.temu-dokter.index')->with('success','Temu dokter berhasil ditambahkan.');
    }
    ...
    public function edit(Request $request)
    {
        ...
        return view('admin.temu_dokter.edit', compact('item','pets','dokters'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('admin.temu-dokter.index')->with('success','Data temu dokter diupdate.');
    }
